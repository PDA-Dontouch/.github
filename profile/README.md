...
사용자의 성향에 따라 수익률 혹은 안정성 순서대로 정렬하여 종목을 보여주며, 실제 규제에 따라 한 종목은 500만원 / 모든 P2P 상품은 합쳐서 4000만까지 투자할 수 있도록 하였습니다.
...
캐릭터를 클릭 후 원하는 명령을 마이크에 대고 말하면 음성인식을 통해 해당 페이지로 이동시켜 줍니다.
서비스의 주 타겟층인 중/장년층이 디지털 어플리케이션에 익숙하지 않을 수 있는 상황을 감안하여 서비스의 접근성을 높일 수 있도록 하였습니다.
